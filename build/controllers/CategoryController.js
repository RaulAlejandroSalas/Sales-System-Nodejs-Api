                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _context.next = 3;
                            return _models2.default.Category.create(req.body);
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _context2.next = 3;
                            return _models2.default.Category.findById({ _id: req.query.id });
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 4;
                            return _models2.default.Category.find({ $or: [{ 'name': new RegExp(pattern, 'i') }, { 'description': new RegExp(pattern, 'i') }] }, { createdAt: 0 }).sort({ 'createdAt': -1 });
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _context4.prev = 0;
                            _context4.next = 3;
                            return _models2.default.Category.findByIdAndUpdate({ _id: req.body.id }, {
                                name: req.body.name,
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            _context5.prev = 0;
                            _context5.next = 3;
                            return _models2.default.Category.findOneAndRemove({ _id: req.body.id });
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.prev = 0;
                            _context6.next = 3;
                            return _models2.default.Category.findByIdAndUpdate({ _id: req.body.id }, { state: 1 });
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            _context7.prev = 0;
                            _context7.next = 3;
                            return _models2.default.Category.findByIdAndUpdate({ _id: req.body.id }, { state: 0 });
