...
exports.default = {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _context.next = 3;
                            return _models2.default.Person.create(req.body);
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _context2.next = 3;
                            return _models2.default.Person.findById({ _id: req.query.id });
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 4;
                            return _models2.default.Person.find({ $or: [{ 'name': new RegExp(pattern, 'i') }, { 'email': new RegExp(pattern, 'i') }] }, { createdAt: 0 }).sort({ 'createdAt': -1 });
    ...
    listClient: function () {
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            pattern = req.query.filter;
                            _context4.next = 4;
                            return _models2.default.Person.find({ $or: [{ 'name': new RegExp(pattern, 'i') }, { 'email': new RegExp(pattern, 'i') }], 'type_person': 'CLIENT' }, { createdAt: 0 }).sort({ 'createdAt': -1 });
        ...
        return function listClient(_x10, _x11, _x12) {
    ...
    listProvider: function () {
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            ...
                            pattern = req.query.filter;
                            _context5.next = 4;
                            return _models2.default.Person.find({ $or: [{ 'name': new RegExp(pattern, 'i') }, { 'email': new RegExp(pattern, 'i') }], 'type_person': 'PROVIDER' }, { createdAt: 0 }).sort({ 'createdAt': -1 });
        ...
        return function listProvider(_x13, _x14, _x15) {
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.prev = 0;
                            _context6.next = 3;
                            return _models2.default.Person.findByIdAndUpdate({ _id: req.body.id }, {
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            _context7.prev = 0;
                            _context7.next = 3;
                            return _models2.default.Person.findOneAndRemove({ _id: req.body.id });
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            _context8.prev = 0;
                            _context8.next = 3;
                            return _models2.default.Person.findByIdAndUpdate({ _id: req.body.id }, { state: 1 });
    ...
    deactivate: function () {
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            _context9.prev = 0;
                            _context9.next = 3;
                            return _models2.default.Person.findByIdAndUpdate({ _id: req.body.id }, { state: 0 });
        ...
        return function deactivate(_x25, _x26, _x27) {
