...
exports.default = {
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            _context3.prev = 0;
                            _context3.next = 3;
                            return _models2.default.Income.create(req.body);
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _context4.prev = 0;
                            _context4.next = 3;
                            return _models2.default.Income.findById({ _id: req.query.id }).populate('users', { name: 1 }).populate('persons', { name: 1 });
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            ...
                            _context5.next = 4;
                            return _models2.default.Income.find({ $or: [{ 'num_receipt': new RegExp(pattern, 'i') }, { 'serie_receipt': new RegExp(pattern, 'i') }] }).populate('users', { name: 1 }).populate('persons', { name: 1 }).sort({ 'createdAt': -1 });
    ...
    getIncomesLast12Months: function () {
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.prev = 0;
                            _context6.next = 3;
                            return _models2.default.Income.aggregate([{
                                $group: {
                                    _id: {
        ...
        return function getIncomesLast12Months(_x14, _x15, _x16) {
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            _context7.prev = 0;
                            _context7.next = 3;
                            return _models2.default.Income.findByIdAndUpdate({ _id: req.body.id }, { state: 1 });
    ...
    deactivate: function () {
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            _context8.prev = 0;
                            _context8.next = 3;
                            return _models2.default.Income.findByIdAndUpdate({ _id: req.body.id }, { state: 0 });
        ...
        return function deactivate(_x20, _x21, _x22) {
